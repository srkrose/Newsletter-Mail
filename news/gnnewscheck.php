...
if ($response !== false) {
    ...
    if (!empty($data['articles'])) {
        ...
        // Get a random index within the range of available articles
        $randomIndex = array_rand($data['articles']);

        // Get the randomly selected article
        $randomArticle = $data['articles'][$randomIndex];
        ...
        $subject = "$firstPart - News Article - $date";
